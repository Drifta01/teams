    ...
    <div className="bg-white rounded-lg shadow-md p-6 mt-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-blue-50 p-4 rounded-lg">
          ...
          <p className="text-sm text-gray-600">
            Average Balance: <span className="font-bold">${averageScore.toFixed(2)}</span>
          </p>
          <p className="text-sm text-gray-600">
            Highest Balance: <span className="font-bold">${highestScore}</span>
          </p>
          <p className="text-sm text-gray-600">
        ...
        <div className="bg-green-50 p-4 rounded-lg">
          <h3 className="font-semibold text-green-800 mb-2">🎰 Slot Game Stats</h3>
          {mostPopularGame && (
        ...
        <div className="bg-purple-50 p-4 rounded-lg">
          <h3 className="font-semibold text-purple-800 mb-2">🏢 Casino Stats</h3>
          <p className="text-sm text-gray-600 mb-2">
            Total Casinos: <span className="font-bold">{Object.keys(teamStats).length}</span>
          </p>
          <div className="space-y-1">
